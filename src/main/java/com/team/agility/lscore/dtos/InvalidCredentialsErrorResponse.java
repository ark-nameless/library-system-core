...
@NoArgsConstructor
@AllArgsConstructor
public class InvalidCredentialsErrorResponse {
    ...
    @Schema(description = "Http Status code", example = HttpConsts.HTTP_FORBIDDEN_CODE)
    private int status;

    @Schema(description = "Http Status description", example = HttpConsts.HTTP_FORBIDDEN_DESC)
