...
public class ConflictErrorResponse {
    ...
    @Schema(description = "Http Status code", example = HttpConsts.HTTP_CONFLICT_CODE)
    private int status;

    @Schema(description = "Http Status description", example = HttpConsts.HTTP_CONFLICT_DESC)
